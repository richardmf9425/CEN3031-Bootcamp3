...
const Listing = require('../models/listings.server.model');
...
describe('Listing Schema Unit Tests', () => {
  ...
  describe('Saving to database', function () {
    ...
    it('saves properly when code and name provided', (done) => {
      new Listing({
        name: listing.name,
        code: listing.code,
      }).save((err, listing) => {
    ...
    it('saves properly when all three properties provided', (done) => {
    ...
    it('throws an error when name not provided', (done) => {
      new Listing({
        code: listing.code,
      }).save((err) => {
        should.exist(err);
    ...
    it('throws an error when code not provided', (done) => {
      new Listing({
        name: listing.name,
      }).save((err) => {
        should.exist(err);
