...
// refers to Express the middleware helper for Node.js
 ...
 */
router.route('/').get(listings.list).post(getCoordinates, listings.create);

/*
  The ':' specifies a URL parameter.
 */
router.route('/:listingId').get(listings.read).put(getCoordinates, listings.update).delete(listings.delete);
